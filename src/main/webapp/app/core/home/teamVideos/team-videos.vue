        ...
        <div class="component">
          <div class="row align-center">
            <div class="small-12 large-12 columns text-component">
              ...
              <p><img loading="lazy" class="alignnone wp-image-629" src="/content/images/Soumyadeb_Chowdhury.jpg" alt="" width="142" height="199" /></p>
              <p><strong>Soumyadeb Chowdhury</strong><br />
                Dr<br />
                Aston Business School<br />
        ...
        <div class="component">
          <div class="row align-center">
            <div class="small-12 large-12 columns text-component">
              ...
              <p><strong>Nur Gundogdu</strong><br />
                Dr<br />
                Aston Business School<br />
